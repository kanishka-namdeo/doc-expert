                                  ...
                                  if (seg.type === 'citation') {
                                    return (
                                      <button
                                        key={j}
                                        onClick={() => {
                                          const sourcePart = m.parts?.find(
                                            (p) => p.type === 'source-document'
                                          );
                                          if (sourcePart && typeof sourcePart === 'object') {
                                            setSelectedSource({
                                              sourceId: String(sourcePart.sourceId || ''),
                                              title: String(sourcePart.title || ''),
                                              filename: String(sourcePart.filename || ''),
                                              mediaType: String(sourcePart.mediaType || ''),
                                            });
                                          }
                                        }}
